                                           ...
                                           at::Tensor& alibi)
{
    ...
    auto prev_key = torch::from_blob(workspace + offset,
                                     ...
                                     {static_cast<int64_t>(hidden_dim * InferenceContext::Instance().GetMaxTokenLength()),
                                      static_cast<int64_t>(k * InferenceContext::Instance().GetMaxTokenLength()),
                                      k,
                                      1},
                                     options);
                                        ...
                                        bool transposed_mode)
{
    ...
    auto intermediate_gemm =
        at::from_blob((T*)intermediate_ptr, {input.size(0), input.size(1), static_cast<int64_t>(mlp_1_out_neurons)}, options);
